...
vim.keymap.set("n", "<leader>w", ":BufferLineCloseOthers <CR>", opts) -- toggle Neotree
vim.keymap.set("n", "<leader>l", ":BufferLineCycleNext <CR>", opts) -- toggle Neotree
vim.keymap.set("n", "<leader>h", ":BufferLineCyclePrev <CR>", opts) -- toggle Neotree
vim.keymap.set("n", "<leader>p", ":BufferLinePick <CR>", opts) -- toggle Neotree
vim.keymap.set("n", "<leader>h", ":BufferLineCyclePrev <CR>", opts) -- toggle Neotree
